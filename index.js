...
let p = client.query('create table if not exists posts(id serial unique not null primary key, author varchar(50), description varchar(255), thread_no integer references threads on delete cascade )');
